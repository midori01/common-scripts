...
==================================	
 ${Green_font_prefix} 1.${Font_color_suffix} chacha20-ietf-poly1305
 ${Green_font_prefix} 2.${Font_color_suffix} xchacha20-ietf-poly1305
 ...
 ${Green_font_prefix} 6.${Font_color_suffix} plain
 ${Green_font_prefix} 7.${Font_color_suffix} 2022-blake3-chacha20-poly1305
 ${Green_font_prefix} 8.${Font_color_suffix} 2022-blake3-aes-256-gcm
==================================
...
Update_Shell(){
	...
	sh_new_ver=$(wget --no-check-certificate -qO- "https://raw.githubusercontent.com/midori01/common-scripts/main/shadowsocks-rust/ss-rust.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1)
	...
	if [[ ${sh_new_ver} != ${sh_ver} ]]; then
		...
		[[ -z "${yn}" ]] && yn="y"
		if [[ ${yn} == [Yy] ]]; then
			wget -O ss-rust.sh --no-check-certificate https://raw.githubusercontent.com/midori01/common-scripts/main/shadowsocks-rust/ss-rust.sh && chmod +x ss-rust.sh
